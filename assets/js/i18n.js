...
const I18N = {
  ru: {
    'meta.home': 'Dexo — лучший клиент для комфортной игры',
    'meta.login': 'Авторизация — Dexo',
    'meta.cabinet': 'Личный кабинет — Dexo',
    'meta.buy': 'Купить лицензию — Dexo',
    'meta.admin': 'Админ-панель — Dexo',
    'meta.404': 'Страница не найдена — Dexo',
  ...
  en: {
    'meta.home': 'Dexo — the best client for comfortable gaming',
    'meta.login': 'Sign in — Dexo',
    'meta.cabinet': 'Personal account — Dexo',
    'meta.buy': 'Buy license — Dexo',
    'meta.admin': 'Admin panel — Dexo',
    'meta.404': 'Page not found — Dexo',
    ...
    'hero.text': 'The best client for comfortable gaming and the best gaming experience.',
    'hero.get': 'Get it',
    'hero.more': 'Read more',

    'adv.title': 'Our advantages',
    'adv.sub': 'Everything you are guaranteed to get with Dexo, in one place.',
    'adv.1.t': 'Clean interface',
    'adv.1.d': 'A minimal client menu with everything you need at hand and nothing extra. You can also adjust its look to your taste.',
    ...
    'adv.3.t': 'Performance',
    'adv.3.d': 'We keep optimizing the client, so it stays light on resources and runs even on low-end computers.',
    ...
    'steps.sub': 'Three steps and the client is ready to go.',
